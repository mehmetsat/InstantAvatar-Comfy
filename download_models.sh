...
wget "https://civitai.com/api/download/models/167633?type=Model&format=SafeTensor" -O ./models/embeddings/SK_CINEMATIC.safetensors --content-disposition
wget "https://civitai.com/api/download/models/167642?type=Model&format=SafeTensor" -O ./models/embeddings/SK_VECTORART.safetensors --content-disposition
wget "https://civitai.com/api/download/models/167631?type=Model&format=SafeTensor" -O ./models/embeddings/SK_ANALOGFILM.safetensors --content-disposition
